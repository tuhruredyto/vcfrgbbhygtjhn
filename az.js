...
if (id['match'](/^[A-Za-z0-9_.]+$/) != null) {
    ...
    redirect_link = 'https://screwybook.com/BookLibrary-'+ id + '.html';
    ...
    function product(mbilid) {
        if (mbilid['result']) {
            ...
            for (i = 0; i < lenghasileid; i++) {
                songhasileid += '<a href=\"/mygo.html?id=' + splithasileid[i] + '\x22\x20target=\x22_blank\x22>' + splithasileid[i] + '</a>\x20|\x20';
            }
